 ...
 *   order.
 *
 *   $Header: //components/rel/boot.bf/3.1.2.c2/boot_images/core/storage/tools/deviceprogrammer/src/firehose/emmc/deviceprogrammer_xml_parser.c#1 $ 
 *   $DateTime: 2015/04/28 11:23:07 $ $Author: pwbldsvc $
 *
...
{
    return *strncpy(dst, src, src_size);
}
